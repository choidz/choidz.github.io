...
![](/images/posts/zabbix-데이터를-grafana로-예쁘게-시각화하기-설치부터-연동까지-00-58dc7355.png)
...
![](/images/posts/zabbix-데이터를-grafana로-예쁘게-시각화하기-설치부터-연동까지-01-aed6e450.png)
...
![](/images/posts/zabbix-데이터를-grafana로-예쁘게-시각화하기-설치부터-연동까지-02-b2467196.png)

**데이터 소스 추가 화면**

**Zabbix 데이터 소스를 선택하면 설정 화면이 나타납니다. 여기서 Zabbix 서버의 정보를 입력해야 합니다.**

![](/images/posts/zabbix-데이터를-grafana로-예쁘게-시각화하기-설치부터-연동까지-03-fd5f74f6.png)
...
![](/images/posts/zabbix-데이터를-grafana로-예쁘게-시각화하기-설치부터-연동까지-04-45afb0eb.png)
...
![](/images/posts/zabbix-데이터를-grafana로-예쁘게-시각화하기-설치부터-연동까지-05-8cac1ca3.png)
