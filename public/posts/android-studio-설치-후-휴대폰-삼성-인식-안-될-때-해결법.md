...
![](/images/posts/android-studio-설치-후-휴대폰-삼성-인식-안-될-때-해결법-00-0fd19c4e.png)
...
| 문제 | 원인 | 해결 |
| --- | --- | --- |
| adb devices 비어 있음 | 드라이버 미설치 | 삼성 USB 드라이버 설치 |
| RSA 창 안 뜸 | USB 디버깅 재인증 필요 | “USB 디버깅 인증서 취소” 후 재연결 |
| 장치 관리자에 “SAMSUNG_Android” 경고 | 드라이버 인식 실패 | 수동 드라이버 업데이트 |
| 기기 안 보임 | 충전 전용 케이블 사용 | 데이터 전송 케이블로 교체 |
