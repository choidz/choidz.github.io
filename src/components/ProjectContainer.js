  ...
  return (
    <div className="flex flex-col gap-y-4 items-center mb-16">
      ...
      <div className="flex flex-row items-center gap-x-4">
        ...
        <a
          href="#!"
          className="flex flex-row items-center bg-white border border-gray-200 max-w-80 rounded-lg shadow md:flex-col  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
        >
          <img
            class="object-fit w-full rounded-t-lg h-96 md:h-auto md:w-fit md:rounded-none md:rounded-s-lg p-4 "
            src="images/projects/DOB.png"
